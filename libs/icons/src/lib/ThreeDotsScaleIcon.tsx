...
export const ThreeDotsScaleIcon = (): ReactElement => {
  return (
    <svg  data-testid="three-dots-scale-icon-testid" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
